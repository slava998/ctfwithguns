...
void onInit(CBlob@ this)
{
	...
	AddIconToken("$icon_pistolammo$", "AmmoIcon_LowCal.png", Vec2f(24,24), 255);
	AddIconToken("$icon_shotgunammo$", "AmmoIcon_Shotgun.png", Vec2f(24,24), 255);
	...
	{
		ShopItem@ s = addShopItem(this, "Boomstick", "$boomstick$", "boomstick", "You see this? A boomstick! The twelve-gauge double-barreled Bobington.\n\nUses Shotgun Shells.");
		AddRequirement(s.requirements, "coin", "", "Coins", 40); //300c
	...
	{
		ShopItem@ s = addShopItem(this, "Shotgun", "$shotgun$", "shotgun", "A short-ranged weapon that deals devastating damage.\n\nUses Shotgun Shells.");
	...
	}
	{
		...
		AddRequirement(s.requirements, "coin", "", "Coins", 90); //1000c
...
void onTick(CBlob@ this)
{
	if(isServer())
	{
		...
		CBlob@ mat = server_CreateBlob(resources[index], this.getTeamNum(), this.getPosition());
		if (mat !is null)
		{
			mat.server_SetQuantity(XORRandom(resourceYields[index]));
		}
