...
void onInit(CBlob@ this)
{
	...
	AddIconToken("$gramophone$", "Gramophone.png", Vec2f(16,16), 255);
	...
	{
		ShopItem@ s = addShopItem(this, "Gramophone", "$gramophone$", "gramophone", "Plays music to maintain discipline in the ranks!", false);
